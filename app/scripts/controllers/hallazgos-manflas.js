...
/**
 * @ngdoc function
 * @name efindingAdminApp.controller:HallazgosManflas
 * @description
 * # HallazgosManflas
...
.controller('HallazgosManflas', function($scope, $log, $state, $filter, $window, $timeout, $uibModal, NgTableParams, Reports, Utils) {

	$scope.page = {
		title: 'Lista de Hallazgos Manflas',
		prevBtn: {
			disabled: true
		},
		nextBtn: {
